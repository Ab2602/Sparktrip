...
function Anyweek(props) {
   
return (
    <div  className='modelbganyweek'>
        <div  onMouseLeave={()=>props.handleAnyweek(false)}  className='modelcontaineranyweek'>
            <div  className='modeldataanyweek'>
